...
RESCUE_SIGNALS: dict[str, list[str]] = {
    "spoilage": [
        "before it goes bad", "before they go bad", "before it goes off",
        "about to expire", "going bad", "goes bad", "go bad", "gone off",
        "about to go off", "will expire", "past its prime", "past their prime",
        "overripe", "over ripe", "wilting", "browning", "turning brown",
        "rotting", "mold", "mouldy", "expiring", "expires tomorrow",
    ...
    "no_storage": [
        ...
        "cant freeze", "no room in", "running out of space",
        "dondurucu yok", "buzdolabı yok", "dondurucum yok",
        "soğutucum yok", "saklayamıyorum",
    ],
    "leftovers": [
        "leftovers", "use up", "use them up", "use it up", "leftover", "use before",
        "need to use", "got a bunch", "too many", "excess", "too much",
        "bought too much", "have a lot of", "have too many", "have too much",
        "artık", "kullanmak", "fazla", "çok var", "kullanmalıyım",
        "tüketmem lazım",
    ],
    "time_pressure": [
        "today", "tonight", "right now", "asap", "urgent", "quickly",
        "by tonight", "by today", "this afternoon", "tomorrow", "by tomorrow",
        "first thing", "soon as possible", "before it", "before they",
        "bugün", "bu gece", "hemen", "acil", "çabuk", "şimdi",
        "bu akşam", "bu öğleden sonra", "yarın",
    ],
    "budget": [
        "cheap", "budget", "affordable", "save money", "don't waste",
        "dont want to waste", "dont waste", "don't want to waste",
        "food waste", "zero waste", "on a budget", "hate wasting",
        "hate throwing", "throwing away", "throw away", "throw it away",
